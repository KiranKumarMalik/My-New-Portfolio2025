...
const seo = {
  ...
  description:
    "A passionate individual who always thrives to work which develop sustainable and scalable social and technical systems to create impact.",
  og: {
    title: "Kiran Kumar Malik",
    type: "website",
...
const greeting = {
  ...
  nickname: "kiran",
  subTitle:
    "A passionate individual who always thrives end to end which develop sustainable and scalable social and technical systems to create impact.",
  resumeLink:
