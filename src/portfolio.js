...
const seo = {
  ...
  description:
    "A passionate who always thrives which develop and scalable social and technical systems to create.",
  og: {
    title: "Kiran Kumar Malik",
    type: "website",
...
const greeting = {
  ...
  nickname: "kiran",
  subTitle:
    "A passionate individual who always end to end and scalable social and systems to create impact.",
  resumeLink:
